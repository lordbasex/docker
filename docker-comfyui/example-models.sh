...
wget https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/loras/wan2.2_t2v_lightx2v_4steps_lora_v1.1_high_noise.safetensors -O loras/wan2.2_t2v_lightx2v_4steps_lora_v1.1_high_noise.safetensors
