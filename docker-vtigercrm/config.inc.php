...
$HELPDESK_SUPPORT_EMAIL_ID = getenv('ADMIN_EMAIL') ?: 'support@vtiger.com';
$HELPDESK_SUPPORT_NAME = getenv('ADMIN_EMAIL') ?: 'your-support name';
...
$dbconfig['db_server'] = getenv('DB_HOSTNAME') ?: 'mysql';
$dbconfig['db_port'] = ':'.(getenv('DB_HOSTNAME_PORT') ?: '3306');
$dbconfig['db_username'] = getenv('DB_USERNAME') ?: 'root';
$dbconfig['db_password'] = getenv('DB_PASSWORD') ?: getenv('MYSQL_ROOT_PASSWORD');
$dbconfig['db_name'] = getenv('DB_NAME') ?: 'vtigercrm';
...
$site_URL = getenv('VT_SITE_URL') ?: 'http://'.$_SERVER['HTTP_HOST'].':'.$_SERVER['SERVER_PORT'].'/';
...
$default_language = getenv('LANGUAGE') ?: 'en_us';
...
$default_timezone = getenv('TIMEZONE') ?: 'UTC';
